...
<body id="page-top">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col auto">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                ...
                                                $sql = "SELECT COUNT(DISTINCT(sf.ShipMethodID)) as ship from purchase_fact sf";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col auto">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(sf.ShipMethodID)) as ships, sm.Ship_Name as ship from purchase_fact sf JOIN shipmethod sm ON sf.ShipMethodID = sm.ShipMethodID";
                                                $query = mysqli_query($mysqli, $sql);
                                                while ($row2 = mysqli_fetch_array($query)) {
    ...
    <script type="text/javascript">
        ...
        $shipment = "SELECT SUM(sf.ReceivedQty) as shipment FROM purchase_fact sf JOIN timedimension t on t.TimeID = sf.TimeID GROUP BY t.Year";
        $i = 1;
