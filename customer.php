...
<head>
    ...
    <title>FP DWO - Laman Customer</title>
...
<body id="page-top">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col auto">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                ...
                                                $sql = "SELECT COUNT(CustomerID) as jumlah_cus from customer";
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col auto">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Jumlah Customer Year 2002</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(a.CustomerID)) customer FROM sales_fact a JOIN timedimension b ON a.TimeID = b.TimeID WHERE b.Year=2002";
                                                $query = mysqli_query($mysqli, $sql);
                                                while ($row2 = mysqli_fetch_array($query)) {
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Trend Peningkatan Jumlah Customer Setiap Year</h6>
                                </div>
                                <div class="card-body">
    ...
    <!-- JavaScript Line Chart Trend Peningkatan Customer tiap Year -->
    <script type="text/javascript">
        ...
        $customer = "SELECT COUNT(DISTINCT(sf.CustomerID)) as customer FROM sales_fact sf JOIN timedimension t on t.TimeID = sf.TimeID GROUP BY t.Year";
        $i = 1;
    ...
    <script type="text/javascript">
        ...
        $database = "deweo";
        $conn = mysqli_connect($host, $user, $password, $database);
        $bulan = "SELECT MONTHNAME(t.Timestamp) bulan FROM sales_fact sf JOIN timedimension t ON sf.TimeID = t.TimeID GROUP BY t.Month";
        $amount1 = "SELECT COUNT(DISTINCT(sf.CustomerID)) as customer FROM sales_fact sf JOIN timedimension t on t.TimeID = sf.TimeID WHERE t.Year = 2004 GROUP BY t.Month";
        $amount2 = "SELECT COUNT(DISTINCT(sf.CustomerID)) as customer FROM sales_fact sf JOIN timedimension t on t.TimeID = sf.TimeID WHERE t.Year = 2003 GROUP BY t.Month";
        $amount3 = "SELECT COUNT(DISTINCT(sf.CustomerID)) as customer FROM sales_fact sf JOIN timedimension t on t.TimeID = sf.TimeID WHERE t.Year = 2002 GROUP BY t.Month";
        $i = 1;
