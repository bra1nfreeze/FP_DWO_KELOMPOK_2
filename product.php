...
<body id="page-top">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Kategori Produk</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(category)) kategori FROM product";
                                                $query = mysqli_query($mysqli, $sql);
                                                while ($row2 = mysqli_fetch_array($query)) {
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT AVG(listprice) as avg FROM product";
                                                $query = mysqli_query($mysqli, $sql);
                                                while ($row2 = mysqli_fetch_array($query)) {
    ...
    <script type="text/javascript">
        ...
        $amount1 = "SELECT SUM(sf.SubTotal) as amount FROM sales_fact sf JOIN timedimension t ON sf.TimeID = t.TimeID WHERE t.Year=2004 GROUP BY t.Month";
        $amount2 = "SELECT SUM(sf.SubTotal) as amount FROM sales_fact sf JOIN timedimension t ON sf.TimeID = t.TimeID WHERE t.Year=2003 GROUP BY t.Month";
        $amount3 = "SELECT SUM(sf.SubTotal) as amount FROM sales_fact sf JOIN timedimension t ON sf.TimeID = t.TimeID WHERE t.Year=2002 GROUP BY t.Month";
        $i = 1;
